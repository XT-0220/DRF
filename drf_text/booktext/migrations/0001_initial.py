# Generated by Django 2.2.5 on 2020-07-28 10:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_delete', models.BooleanField(default=False, verbose_name='删除标记')),
                ('hbook', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='booktext.BookInfo', verbose_name='所属图书')),
            ],
            options={
                'db_table': 'tb_heros',
            },
